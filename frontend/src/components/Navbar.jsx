...
export const Navbar = ({ onMenuToggle }) => {
  ...
  return (
      <nav className="bg-gray-900 px-6 py-2 shadow-lg relative">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              <button
                  ...
                  className="flex items-center space-x-3 hover:bg-gray-800 rounded-lg px-3 py-2 transition-all duration-200"
              >
