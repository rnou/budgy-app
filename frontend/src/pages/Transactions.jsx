...
// Initial form state - defined outside component to avoid recreation
...
export const Transactions = () => {
  ...
  // Combined modal state - Improvement #3
  ...
  // Memoized filtered transactions - only recalculate when dependencies change
  ...
  // Callbacks to avoid recreation on each render
        ...
        <div key={id} className="p-6 hover:bg-gray-50 transition-colors">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4 flex-shrink-0">
              <span
                className={`text-lg font-bold ${isPositive ? "text-green-600" : "text-gray-900"}`}
              >
